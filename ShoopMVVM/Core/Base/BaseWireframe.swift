...
open class BaseWireframe: WireframeProtocol {
    ...
    public var parentWireframe: WireframeProtocol?
    ...
    public func pushChildWireframe(_ childWireframe: WireframeProtocol,
                                   animated: Bool) {
    ...
    public func presentChildWireframe(_ childWireframe: WireframeProtocol,
                                      animated: Bool,
                                      completion: (() -> Void)?) {
        childWireframe.parentWireframe = self
    ...
    public func closeWireframe(animated: Bool,
                               completion: (() -> Void)?) {
